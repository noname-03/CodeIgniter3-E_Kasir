                ...
                <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                  <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                      ...
                      <!-- body -->
                        <form action="<?php echo base_url().'index.php/User_Read_Write/User_Read_Write/data_tanggal_input_aksi' ?>" method="POST">
                        <div class="row">
                        <div class="col-md-5">
                      ...
                      <tbody>
                        <?php 
                          ...
                          <tr>
                              ...
                              <td><a href="<?php echo base_url()."index.php/User_Read_Write/User_Read_Write/data_transaksi_input/$tanggal->id_tanggal"?>" 
                                  class="text-info"><i class="material-icons">add</i>Tambah Transaksi</a></td>
                              <td><a href="<?php echo base_url()."index.php/User_Read_Write/User_Read_Write/data_transaksi_view/$tanggal->id_tanggal"?>" 
                                  class="text-secondary"><i class="material-icons">preview</i>Lihat Transaksi</a></td>
                              <td><a href="<?php echo base_url()."index.php/User_Read_Write/User_Read_Write/data_tanggal_edit/$tanggal->id_tanggal"?>" 
                                  class="text-success"><i class="material-icons">edit</i>Edit Tanggal</a></td>
                              <td>
                              <a href="<?php echo base_url()."index.php/User_Read_Write/User_Read_Write/data_tanggal_delete/$tanggal->id_tanggal"?>" 
