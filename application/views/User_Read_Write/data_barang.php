          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-body">
                <a href="<?php echo base_url().'index.php/User_Read_Write/User_Read_Write/data_barang_input'?>" class="btn btn-primary">Tambahkan Data</a><br><br>
                      ...
                      <tbody>
                        <?php 
                          ...
                          <tr>
                              ...
                              <td><a href="<?php echo base_url()."index.php/User_Read_Write/User_Read_Write/data_barang_edit/$barang->id_barang"?>" 
                                  class="text-success"><i class="material-icons">edit</i></a></td>
                              <td><a href="<?php echo base_url()."index.php/User_Read_Write/User_Read_Write/data_barang_delete/$barang->id_barang"?>" 
