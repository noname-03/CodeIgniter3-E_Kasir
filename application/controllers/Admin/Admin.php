...
class Admin extends CI_Controller{
    ...
    function data_user_toko(){
        ...
        $this->load->view('Admin/Template/headerandmenu.php');
        $this->load->view('Admin/Template/menu2.php');
        $this->load->view('Admin/data_user_toko.php',$data);
        $this->load->view('Admin/Template/footer.php');
    }
    function data_user_toko_input(){
        $this->load->view('Admin/Template/headerandmenu.php');
        $this->load->view('Admin/Template/menu2.php');
        $this->load->view('Admin/data_user_toko_input.php');
        $this->load->view('Admin/Template/footer.php');
    }
    function data_user_toko_input_aksi(){
        ...
        redirect('Admin/Admin/data_user_toko');
    }
    function data_user_toko_edit($id_user_toko){
        ...
        $this->load->view('Admin/Template/headerandmenu.php');
        $this->load->view('Admin/Template/menu2.php');
        $this->load->view('Admin/data_user_toko_edit.php',$data);
        $this->load->view('Admin/Template/footer.php');
    }
    ...
    function data_barang(){
        ...
        $this->load->view('Admin/Template/headerandmenu.php');
        $this->load->view('Admin/Template/menu2.php');
        $this->load->view('Admin/data_barang.php',$data);
        $this->load->view('Admin/Template/footer.php');
    }
    function data_barang_input(){
        $this->load->view('Admin/Template/headerandmenu.php');
        $this->load->view('Admin/Template/menu2.php');
        $this->load->view('Admin/data_barang_input.php');
        $this->load->view('Admin/Template/footer.php');
    }
    function data_barang_input_aksi(){
        ...
        redirect('Admin/Admin/data_barang');
    }
    function data_barang_edit($id_barang){
        ...
        $this->load->view('Admin/Template/headerandmenu.php');
        $this->load->view('Admin/Template/menu2.php');
        $this->load->view('Admin/data_barang_edit.php',$data);
        $this->load->view('Admin/Template/footer.php');
    }
    ...
    function data_transaksi_input($id_tanggal){
        ...
        $this->load->view('Admin/Template/headerandmenu.php');
        $this->load->view('Admin/Template/menu2.php');
        $this->load->view('Admin/data_transaksi_input.php',$data);
        $this->load->view('Admin/Template/footer.php');
    }
    ...
    function cetak_data($id_tanggal){
        ...
        $data['tbl_barang'] = $this->M_Tanggal->Join_Barang($id_tanggal);
        $data['tbl_tanggal']=$this->M_Tanggal->view_data($where,'tbl_tanggal')->result();
        $this->load->view('Admin/cetak_data.php',$data);
    }
