<?php 
class User_Read extends CI_Controller{
    ...
    function index(){
        $this->load->view('User_Read/Template/headerandmenu.php');
        $this->load->view('User_Read/Template/menu2.php');
        $this->load->view('User_Read/index.php');
        $this->load->view('User_Read/Template/footer.php');
    }
    // user toko
    function data_user_toko(){
        ...
        $this->load->view('User_Read/Template/headerandmenu.php');
        $this->load->view('User_Read/Template/menu2.php');
        $this->load->view('User_Read/data_user_toko.php',$data);
        $this->load->view('User_Read/Template/footer.php');
    }
    function data_user_toko_input(){
        $this->load->view('User_Read/Template/headerandmenu.php');
        $this->load->view('User_Read/Template/menu2.php');
        $this->load->view('User_Read/data_user_toko_input.php');
        $this->load->view('User_Read/Template/footer.php');
    }
    function data_user_toko_input_aksi(){
        ...
        redirect('User_Read/User_Read/data_user_toko');
    }
    function data_user_toko_edit($id_user_toko){
        ...
        $this->load->view('User_Read/Template/headerandmenu.php');
        $this->load->view('User_Read/Template/menu2.php');
        $this->load->view('User_Read/data_user_toko_edit.php',$data);
        $this->load->view('User_Read/Template/footer.php');
    }
    ...
    function data_barang(){
        ...
        $this->load->view('User_Read/Template/headerandmenu.php');
        $this->load->view('User_Read/Template/menu2.php');
        $this->load->view('User_Read/data_barang.php',$data);
        $this->load->view('User_Read/Template/footer.php');
    }
    function data_barang_input(){
        $this->load->view('User_Read/Template/headerandmenu.php');
        $this->load->view('User_Read/Template/menu2.php');
        $this->load->view('User_Read/data_barang_input.php');
        $this->load->view('User_Read/Template/footer.php');
    }
    function data_barang_input_aksi(){
        ...
        redirect('User_Read/User_Read/data_barang');
    }
    function data_barang_edit($id_barang){
        ...
        $this->load->view('User_Read/Template/headerandmenu.php');
        $this->load->view('User_Read/Template/menu2.php');
        $this->load->view('User_Read/data_barang_edit.php',$data);
        $this->load->view('User_Read/Template/footer.php');
    }
    ...
    function transaksi(){
        ...
        $this->load->view('User_Read/Template/headerandmenu.php');
        $this->load->view('User_Read/Template/menu2.php');
        $this->load->view('User_Read/transaksi.php',$data);
        $this->load->view('User_Read/Template/footer.php');
    }
    // tanggal
    function data_tanggal_input_aksi(){
        ...
        redirect('User_Read/User_Read/transaksi');
    }
    function data_transaksi_input($id_tanggal){
        ...
        $this->load->view('User_Read/Template/headerandmenu.php');
        $this->load->view('User_Read/Template/menu2.php');
        $this->load->view('User_Read/data_transaksi_input.php',$data);
        $this->load->view('User_Read/Template/footer.php');
    }
    function data_transaksi_view($id_tanggal){
        ...
        $this->load->view('User_Read/Template/headerandmenu.php');
        $this->load->view('User_Read/Template/menu2.php');
        $this->load->view('User_Read/data_transaksi.php',$data);
        $this->load->view('User_Read/Template/footer.php');
    }
